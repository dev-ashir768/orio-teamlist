...
import {
  ...
  MoreVert,
  Padding,
} from "@mui/icons-material"; // Import ArrowBack icon
          ...
          {activeSection === "dashboard" && (
            ...
            >
              <Typography
                ...
                sx={{ color: "text.secondary" }}
              >
                Welcome to Teamlist! Select "Projects" to get started.
              </Typography>
            </Box>
          )}

          {activeSection === "projects" && (
            <Box style={{ padding: '20px', backgroundColor: "#fff", borderRadius: "12px" }}>
